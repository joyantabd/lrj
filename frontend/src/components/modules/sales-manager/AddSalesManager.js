...
const AddSalesManager = () => {
    ...
    const handleSubmit = (e) => {
        setIsLoading(true)
        axios.post(`${Constants.BASE_URL}/sales_manager`, input).then(res => {
            setIsLoading(false)
            Swal.fire({
                position: 'top-end',
                icon: res.data.cls,
    ...
    return (
        <div>
            <BreadCrumb title={`New Sales Manager`} />

            <div className="row my-4">
                <div className='col-md-8'>
                    <div className='card'>
                        <div className='card-header'>
                            <CardHeader title={'Add Sales Manager'} button_text={'List'} icon={<FaList />} link={'/sales-manager'} />
                        </div>
                                ...
                                <div className='col-md-6'>
                                    <div className='card'>
                                        ...
                                        <p className='login-error-msg'><small>{errors.shop_id !== undefined ? errors.shop_id[0] : null}</small></p>
                                            ...
                                            <label className='w-100 mt-2'>
                                                <p>Password</p>
                                                <input className={errors.password !== undefined ? 'is-invalid form-control col-md-5' : 'form-control col-md-5'} type='password' name='password' value={input.password} onChange={handleChange} placeholder='Enter Password' />
                                        ...
                                        <label className='w-100 mt-2'>
                                            ...
                                            {input.nid_photo !== undefined ?
                                                <div className='row'>
                                                    <div className='col-md-6'>
                                                        <div className='photo-preview mt-3'>
                                                            <img alt='Image Preview' src={input.nid_photo} className='img-thumbnail aspect-one' />
                                                        </div>
                                                    </div>
                                                </div>
                                                : null}
                                        ...
                                        <div className="col-md-4">
                                            <div className="d-grid mt-4">
                                                <button className={'btn btn-success'} onClick={handleSubmit}
                                                        dangerouslySetInnerHTML={{__html: isloading ? '<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> Loading...' : 'Add Manager'}}/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
