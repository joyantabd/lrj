...
getDivisions()
    ...
    return (
        <div>
            <BreadCrumb title={`New Shop`} />

            <div className="row my-2">
                <div className='col-md-8'>
                    <div className='card'>
                        <div className='card-header'>
                            <CardHeader title={'Add Shop'} button_text={'List'} icon={<FaList />} link={'/shop'} />
                        </div>
                                        ...
                                        <div className="col-md-4">
                                            <div className="d-grid mt-4">
                                                <button className={'btn btn-success'} onClick={handleSubmit}
                                                        dangerouslySetInnerHTML={{__html: isloading ? '<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> Loading...' : 'Add Shop'}}/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
