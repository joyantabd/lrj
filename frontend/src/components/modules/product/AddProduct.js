...
import { FaList, FaMinus, FaPlus, FaTrash } from 'react-icons/fa';
...
const AddProduct = () => {
    ...
    const getAttributes = () => {
        axios.get(`${Constants.BASE_URL}/attribute_info`).then(res => {
            setAttributes(res.data)
        })
    }
    const getSuppliers = () => {
        axios.get(`${Constants.BASE_URL}/supplier_info`).then(res => {
            setSuppliers(res.data)
        })
    }
    const getCountries = () => {
        axios.get(`${Constants.BASE_URL}/country_info`).then(res => {
    ...
    const getBrands = () => {
        axios.get(`${Constants.BASE_URL}/brand_info`).then(res => {
            setBrands(res.data)
        })
    }
                ...
                <div className="col-md-12">
                    <div className="card">
                        <div className="card-header">
                            <CardHeader title={'Add Product'} link={'/product'} icon={<FaList/>} button_text={'List'}/>
                        </div>
                                            ...
                                            {attributeFiled.map((id, ind)=>(
                                                <div key={ind} className="row my-2 align-items-baseline">
                                                    ...
                                                    <div className="col-md-2">
                                                        ...
                                                        <button className={'btn btn-danger'} onClick={()=>handleAttributeFieldsRemove(id)}><FaMinus/>
                                                        </button>:null
                                                        }
                                                    </div>
                                                </div>
                                ...
                                <div className="col-md-12">
                                    <div className="card my-4">
                                        ...
                                        <div className="card-body">
                                                ...
                                                <div key={ind} className="row my-2 align-items-baseline">
                                                    ...
                                                    <div className="col-md-2">
                                                        {specificationFiled.length -1 == ind ?
                                                            <button className={'btn btn-danger'} onClick={()=>handleSpecificationFieldRemove(id)}><FaMinus/>
                                                            </button> : null
                                                        }
                                            ...
                                            <div className="row">
                                                <div className="col-md-12 text-center">
                                                    <button className={'btn btn-success'} onClick={handleSpecificationFields}><FaPlus/></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-md-4">
                                            <div className="d-grid mt-4">
                                                <button className={'btn btn-success'} onClick={handleProductCreate}
