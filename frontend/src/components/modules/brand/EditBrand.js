...
const EditBrand = () => {
    ...
    const getCategory = () =>{
        axios.get(`${Constants.BASE_URL}/brands/${params.id}`).then(res => {
    ...
    const handleSubmit = () =>{
        setIsLoading(true)
        axios.put(`${Constants.BASE_URL}/brands/${params.id}`, input).then(res => {
                ...
                <div className='col-md-8'>
                    <div className='card'>
                        <div className='card-header'>
                           <CardHeader title={'Edit Brand'} button_text={'List'} icon={<FaList/>} link={'/brand'}/>
                        </div>
